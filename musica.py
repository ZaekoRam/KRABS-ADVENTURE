...
def _ensure_init():
    global _inited
    global sfx_cuota_ok  # ✅ para que quede guardado en musica.py

    if not _inited:
        pygame.mixer.init()

        # --- SFX cuota completada ---
        try:
            sfx_cuota_ok = pygame.mixer.Sound("assets/audio/sfx/cuota_ok.wav")
            sfx_cuota_ok.set_volume(0.8)
        except Exception as e:
            sfx_cuota_ok = None
            print("[musica] ERROR cargando cuota_ok:", e)
